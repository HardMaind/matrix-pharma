      ...
      <section className="aboutus-vision">
        <div className="container grid-container">
          ...
          <div className="col-span-4 aboutus-vision-col3">
            ...
            <p>
              We believe true success is rooted in collective strength. We B 4 1
          ...
          <div className="leadership-content">
            ...
            >
              <p>
                ...
                subsidiary of Matrix Pharma Corp, as Chief Executive Officer in
                August 2024. With 36 years in the pharmaceutical industry,
                including 22 years in leadership roles, he brings extensive
                expertise in global operations, business transformation, and
                strategic growth.
              </p>
              <p>
                Prior to Tianish, Mr. Jain led PI Health Sciences, spearheading
                ...
                framework for sustainability. He also served as COO of Aurobindo
                Pharma, strengthening its global API business.
              </p>
              <p>
          ...
          <div className="leadership-content">
            ...
            >
              <p>
                ...
                Corporate Officer at Tianish Laboratories Private Limited. She
                leads corporate strategy, people, and culture initiatives,
                driving a workplace rooted in transparency, integrity, and
                employee empowerment through recognition, respect, and rewards.
              </p>
              <p>
                Swathi is also the Founder of Mudhra Ventures, investing in
                early-stage startups. Her portfolio includes Pahadi Local, Dough
                Mama, and SeeSaw Spaces. She also produced the psychological
                thriller Mangalavaaram under Mudhra Media Works.
              </p>
              <p>
                A Stanford University alumna specializing in Family Business
          ...
          <div className="leadership-content">
            ...
            >
              <p>
                ...
                Director of Tianish Laboratories Private Limited. Tianish is
                recognized as a global leader in API manufacturing, and under
                his leadership in sourcing and financial strategy, the company
                continues to drive pharmaceutical innovation and excellence.
              </p>
              <p>
