  ...
  const matrixDataArray = [
    {
      ...
      listItems: [
        ...
        "Advanced technologies for precise particle size customization.",
    ...
    },
    {
      ...
      listItems: [
        ...
        "Advanced facilities equipped for formulation and process optimization.",
    ...
    },
    {
      ...
      listItems: [
        ...
        "Continuous monitoring, internal audits, and training to meet evolving global standards.",
        "This ensures smooth regulatory approvals and consistent market access worldwide.",
      ],
    },
    {
      ...
      listItems: [
        ...
        "Expansion into niche and high-demand therapeutic categories, ensuring adaptability to market trends. ",
        "This diversity enables you to address varied healthcare needs with confidence and flexibility.",
      ],
    },
    {
      ...
      listItems: [
        ...
        "Process development to optimize yield and reduce costs. ",
    ...
    },
    {
      ...
      listItems: [
        ...
        "Our commitment to personalized support ensures your success at every stage, from development to market entry.",
      ],
    },
  ];
  ...
  return (
    <Layout>
      <Hero
        ...
        imgPath="/assets/images/matrix-advantages-web.jpg"
      />
